...
// long version:
// const fifteenthC = inventors.filter(function(inventor) {
//   if (inventor.year >= 1500 && inventor.year <= 1599) {
//     return true;
//   }
// });

const fifteenthC = inventors.filter(inventor => (inventor.year >= 1500 && inventor.year <= 1599));
console.table(fifteenthC); // view results as a table
